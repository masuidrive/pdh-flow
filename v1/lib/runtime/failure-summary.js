...
export function writeFailureSummary({ stateDir, repoPath, runId, stepId, reason, provider = "runtime", status = "failed", attempt = null, maxAttempts = null, exitCode = null, timedOut = false, timeoutKind = null, signal = null, rawLogPath = null, finalMessage = null, stderr = null, failedGuards = [], reviewContext = null, message = null, nextCommands = [] }) {
...
function renderFailureSummary({ runId, stepId, reason, provider, status, attempt, maxAttempts, exitCode, timedOut, timeoutKind, signal, rawLogPath, finalMessage, stderr, failedGuards, reviewContext, message, nextCommands }) {
    const lines = [
