import { runProvider } from "../process-control.js";
export async function runClaude({ cwd, prompt, rawLogPath, env = {}, bare = false, disableSlashCommands = false, settingSources = null, includePartialMessages = false, model = null, permissionMode = "bypassPermissions", resume = null, timeoutMs = null, idleTimeoutMs = null, killGraceMs = 5000, onSpawn = () => { }, onEvent = () => { } }) {
